...
- **Bundles**: `app/ai-app/docs/sdk/bundle/bundle-README.md`
- **Economics & accounting**: `app/ai-app/docs/sdk/infra/economics`
- **Monitoring & autoscaling**: `app/ai-app/docs/service/README-monitoring-observability.md`

### Reference

- Architecture: `app/ai-app/docs/arch/architecture-short.md`
...
- **Tooling + isolated runtime**: `app/ai-app/docs/sdk/runtime`
