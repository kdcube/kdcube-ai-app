...
UI file:
- [EconomicsDashboard.tsx](../../src/kdcube-ai-app/kdcube_ai_app/apps/chat/api/control_plane/EconomicsDashboard.tsx)

Backend routes:
- [control_plane.py](../../src/kdcube-ai-app/kdcube_ai_app/apps/chat/api/control_plane/control_plane.py)
