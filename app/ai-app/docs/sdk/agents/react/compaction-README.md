...
- a preserved hidden snapshot ref for each older compacted plan under:
...
For plan history specifically, the primary recovery handles are the carried `react.plan.history` refs rather than the digest itself.
