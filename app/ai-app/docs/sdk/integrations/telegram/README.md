...
- [Telegram SDK Integration](telegram-README.md) - reusable KDCube SDK modules,
  bundle wiring, webhook submitter helpers, Bot API rendering, progress
  streaming, Mini App auth, widget operations, and signed downloads.
