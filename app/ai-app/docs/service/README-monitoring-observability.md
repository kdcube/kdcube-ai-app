...
See implementation: [monitoring.py](../../src/kdcube-ai-app/kdcube_ai_app/apps/chat/api/monitoring/monitoring.py)
...
- Gateway middleware: [web_app.py](../../src/kdcube-ai-app/kdcube_ai_app/apps/chat/api/web_app.py)
