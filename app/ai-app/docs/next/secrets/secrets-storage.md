---
id: ks:docs/next/secrets/secrets-storage.md
title: "Draft: Secrets Storage Model"
summary: "Draft proposal for a unified secrets storage model that works across local development, shared dev environments, and production while keeping configuration and secrets separate."
draft: true
status: proposal
tags: ["next", "secrets", "storage", "configuration", "design"]
keywords: ["unified secrets storage", "config versus secrets files", "local and production secret model", "secret persistence design", "runtime secret loading", "deployment secret interface"]
see_also:
