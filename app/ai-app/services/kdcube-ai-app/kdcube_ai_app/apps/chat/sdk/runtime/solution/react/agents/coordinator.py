...
async def coordinator_planner_stream(
    ...
    sys_1 = (
        ...
        "The turn log entry [user.prompt] is a preview and may be truncated when the user message is long.\n"
        "If [user.prompt] ends with [truncated], use [USER_MESSAGE] as the authoritative full text.\n"
        "Semantic summaries of user attachments, if any, are in [user.attachments.<attachment name>].\n"
        ...
        "• In the journal, [TURN MEMORIES — CHRONOLOGICAL (newest→oldest)] lists recent per-turn memories (preferences/signals).\n"
