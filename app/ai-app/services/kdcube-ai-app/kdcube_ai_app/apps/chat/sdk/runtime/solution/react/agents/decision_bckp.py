...
class ToolCallDecision(BaseModel):
    ...
    notes: str = Field(..., description="Why we call this tool (for session log)")
...
- Strategical planning: if you plan multiple rounds ahead, in your notes you can specify which skills to load in upcoming rounds and why. If you know data must comply with specific format/structure, even if it must be processed multiple times into multiple shapes, you should plan the optimal data representation early and make sure the skill(s) that govern the goal format/structure are connected as early as possible to avoid redundant processing / rework.
- Remember:
