...
def _load_package_root(bundle_root: pathlib.Path):
    package_name = "_test_react_doc_bundle_pkg"
...
def test_react_doc_shared_signature_skips_rebuild(tmp_path, monkeypatch):
    ...
    signature = "repo|main|docs|None|None|None|True"
