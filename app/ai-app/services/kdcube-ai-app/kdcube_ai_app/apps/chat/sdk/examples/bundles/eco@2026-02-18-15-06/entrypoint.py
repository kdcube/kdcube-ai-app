...
class EcoEntrypoint(BaseEntrypointWithEconomics):
    ...
    @property
    def app_quota_policies(self) -> Dict[str, QuotaPolicy]:
        """Get quota policies from bundle configuration."""
    ...
    @property
    def app_budget_policies(self) -> dict[str, ProviderBudgetPolicy]:
        """
        Define application-level budget limits per provider.

        These limits apply across ALL users of this bundle within this tenant/project.
        """
        return {
