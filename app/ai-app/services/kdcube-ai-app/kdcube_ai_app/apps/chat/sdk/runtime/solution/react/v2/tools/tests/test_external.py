...
from kdcube_ai_app.apps.chat.sdk.runtime.solution.react.v2.tools.external import handle_external_tool
...
async def test_external_exec_path_rewrite_notice(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("kdcube_ai_app.apps.chat.sdk.runtime.solution.react.v2.tools.external.execute_tool", _fake_execute_tool)
