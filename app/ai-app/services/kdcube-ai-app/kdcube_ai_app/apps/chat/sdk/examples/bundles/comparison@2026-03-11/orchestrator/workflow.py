...
# Core orchestration logic for the comparison bundle.
# Same gate -> solver pattern as the react bundle.
...
class ComparisonWorkflow(BaseWorkflow):
    def __init__(
        ...
        *,
        ...
        self.runtime_ctx.max_iterations = 20
    ...
    async def process(self, payload: dict) -> Dict[str, Any]:
        ...
        try:
            async def _gate_node(state: Dict[str, Any]) -> Dict[str, Any]:
                ...
                logging_helpers.log_agent_packet("gate", "gate", {
                ...
                scratchpad.clarification_questions = [
                    q.strip() for q in (gate_payload.get("clarification_questions") or []) if q.strip()
                ]
