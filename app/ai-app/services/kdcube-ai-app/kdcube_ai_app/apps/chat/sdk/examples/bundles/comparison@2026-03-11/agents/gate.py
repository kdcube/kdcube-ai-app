...
#
# ── agents/gate.py ──
# Gate agent for the comparison bundle.
# Same pattern as the react bundle gate — proposes conversation title.
...
async def gate_stream(
    ...
    *,
    ...
    sys_prompt = (
        "You are a gate agent for a technology comparison assistant.\n"
