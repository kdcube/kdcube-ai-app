...
def test_ensure_example_bundle_shared_uses_versioned_path(monkeypatch, tmp_path):
    src = tmp_path / "react.doc@2026-03-02-22-10"
...
def test_cleanup_old_shared_example_bundles_keeps_active_version(monkeypatch, tmp_path):
    ...
    old_dir = root / "react.doc@2026-03-02-22-10__2026.3.20.111__aaaaaaaaaaaa"
    new_dir = root / "react.doc@2026-03-02-22-10__2026.3.21.410__bbbbbbbbbbbb"
    ...
    removed = bundle_store.cleanup_old_shared_example_bundles(
        bundle_id="react.doc@2026-03-02-22-10",
        bundles_root=root,
        keep=1,
