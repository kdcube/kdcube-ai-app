...
from kdcube_ai_app.apps.chat.sdk.solutions.react.v3.tools.hide import handle_react_hide
from kdcube_ai_app.apps.chat.sdk.solutions.react.v3.tools.tests.helpers import FakeBrowser, FakeReact
...
async def _render_pdf_into_timeline(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(
        "kdcube_ai_app.apps.chat.sdk.solutions.react.v3.tools.external.execute_tool",
        _fake_execute_tool,
    )
