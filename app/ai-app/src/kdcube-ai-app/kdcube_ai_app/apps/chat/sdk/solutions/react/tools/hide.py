...
TOOL_SPEC = {
    ...
    "purpose": (
        ...
        "This tool accepts a logical path (conv:ar:, conv:fi:, conv:tc:, conv:so:), not a search query."
    ),
    "args": {
        "path": "str (FIRST FIELD). Logical block path to hide (conv:ar:, conv:fi:, conv:tc:, conv:so:).",
