...
"""
Demo: call MCP web_search via stdio (on-demand process).

Requirements:
  - MCP_SERVICES env configured with a stdio server for "web_search"
  - web_search MCP server module available in PYTHONPATH
"""
...
async def main() -> None:
    ...
    result = await mcp.execute_tool(
        ...
        params={"queries": "openai mcp", "n": 3, "fetch_content": False},
    )
