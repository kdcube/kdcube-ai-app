...
from kdcube_ai_app.apps.chat.sdk.solutions.react.layout import build_instruction_catalog_block
...
async def coordinator_planner_stream_v2(
    ...
    *,
    ...
    sys_1 = (
        ...
        "If the user explicitly asked for a plan only, a short plan first, brainstorming only, or said not to execute yet, choose final_answer and stop at the planning/advice layer for this turn.\n"
