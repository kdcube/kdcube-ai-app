...
Run with:
  BUNDLE_UNDER_TEST=/abs/path/to/bundle pytest test_custom_tools_integration.py -v
  pytest test_custom_tools_integration.py --bundle-path=/abs/path/to/bundle -v
"""
