...
function routeContextFromLocation(): { tenant: string; project: string; bundleId: string } {
...
class SettingsManager {
    ...
    getTenant(): string {
        return isTemplatePlaceholder(this.settings.defaultTenant) ? ROUTE_CONTEXT.tenant : this.settings.defaultTenant;
    }

    getProject(): string {
        return isTemplatePlaceholder(this.settings.defaultProject) ? ROUTE_CONTEXT.project : this.settings.defaultProject;
    }
