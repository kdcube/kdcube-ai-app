...
function canonicalPayloadRef(
  ...
  const ref = canonicalObjectRef(
    ...
    durableHistoricalObjectRef(payload.object_ref, conversationId),
    durableHistoricalObjectRef(payload.objectRef, conversationId),
    ...
    durableHistoricalObjectRef(meta.object_ref, conversationId),
    durableHistoricalObjectRef(meta.objectRef, conversationId),
