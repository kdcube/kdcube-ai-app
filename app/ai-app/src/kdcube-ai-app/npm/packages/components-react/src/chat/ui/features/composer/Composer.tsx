...
import { memo, useEffect, useMemo, useRef, useState, type CSSProperties, type DragEvent, type KeyboardEvent, type MouseEvent } from 'react'
...
function ComposerImpl({
  ...
  function activateContext(ctx: AttachedContext) {
    // Engine-bound; the engine surfaces any failure as a service-notice event.
    vm.openContextChip(ctx)
  }
          ...
          <div className="k-context-chip-list">
            {contexts.map((ctx) => (
              <span
                ...
                style={contextChipStyle(ctx, namespaceStyles) as CSSProperties | undefined}
